...
mysql_connect($envjson['DOTCLOUD_DB_MYSQL_HOST'].':'.$envjson['DOTCLOUD_DB_MYSQL_PORT'], $envjson['DOTCLOUD_DB_MYSQL_LOGIN'], $envjson['DOTCLOUD_DB_MYSQL_PASSWORD']) or die('Can\'t connect');
